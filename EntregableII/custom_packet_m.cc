//
// Generated file, do not edit! Created by nedtool 5.7 from custom_packet.msg.
//
...
int CustomPacket::getFromSource() const
{
    return this->fromSource;
}

void CustomPacket::setFromSource(int fromSource)
{
    this->fromSource = fromSource;
}

int CustomPacket::getSequenceNumber() const
{
    return this->sequenceNumber;
}

void CustomPacket::setSequenceNumber(int sequenceNumber)
{
    this->sequenceNumber = sequenceNumber;
}

int CustomPacket::getOrigin() const
{
    return this->origin;
}

void CustomPacket::setOrigin(int origin)
{
    this->origin = origin;
}
